...
@section('content')
    <label for="dark-mode-toggle" id="dark-mode-toggle-switch-label" style="position: absolute;
                                                    right: 5rem;
                                                    top: 5.5rem;
                                                    font-size: 1rem;
                                                    font-weight: bolder;
                                                    color: rgb(0, 0, 0);">Dark mode</label>
    <div id="dark-mode-container" onclick="DarkModeSwitcher()" style="background-color: rgb(0, 0, 0);
                                                    width: 7rem;
                                                    height: 3rem;
                                                    ...
                                                    right: 4rem;
                                                    top: 7rem;">
        <div id="offDarkMode" style="background-color: #4A5568;
                                                    width: 2.5rem;
                                                    height: 2.5rem;
                                                    border-radius: 50%;
                                                    position: absolute;
                                                    left: 0.25rem;
                                                    top: 0.25rem;">⁫</div>
        <div id="onDarkMode" style="background-color: #4A5568;
                                                    width: 2.5rem;
                                                    height: 2.5rem;
                                                    border-radius: 50%;
                                                    position: absolute;
