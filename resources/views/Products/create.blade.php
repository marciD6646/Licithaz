    ...
    <div class="container mx-auto p-4">
        ...
        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" id="CreateForm"
            ...
            <div class="mb-4">
                ...
                <textarea name="description" id="description" class="CreateFormText w-full border border-gray-300 p-2 rounded" required></textarea>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="file" name="image" id="image"
                    class="CreateFormText w-full border border-gray-300 p-2 rounded">
            </div>
